...
<div class="container">
    ...
    <div class="container mt-5">
        ...
        <form id="addProductForm" method="POST" action="/store-post" enctype="multipart/form-data"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="number" class="form-control" id="availableQuantity" name="available_quantity"
            ...
            <textarea id="summernote" name="content" data-parsley-trigger="change" placeholder="Description"></textarea>
            <div class="parsley-errors-list"></div>
